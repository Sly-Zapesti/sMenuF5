...
RegisterNetEvent("Sly:Fmenu")
AddEventHandler("Sly:Fmenu", function(value, quantity)
...
ESX.TriggerServerCallback('Sly:getOtherPlayerData', function(data)
...
menuf5 = {
    Base = { Header = {"commonmenu", "interaction_bgd"}, Color = {color_black}, HeaderColor = {255,24,20}, Title = "Inventaire Rogue Life"},
    ...
    Events = {
		onSelected = function(self, _, btn, PMenu, menuData, currentButton, currentBtn, currentSlt, result, slide)
                ...
                for i=1, #ESX.PlayerData.inventory, 1 do
                    ...
                    if btn.slidename == "Donner" and btn.name == ESX.PlayerData.inventory[i].label .. " ~b~x"..count then
                        ...
                        if ESX.PlayerData.inventory[i].label .. " ~b~x"..count == btn.name and count > 0 then
                            ...
                            Slyzap.closestPlayer, Slyzap.closestDistance = ESX.Game.GetClosestPlayer()
                            if Slyzap.closestDistance ~= -1 and Slyzap.closestDistance <= 3 then
                                foundPlayers = true
                            end
                            if foundPlayers == true then
                                local closestPed = GetPlayerPed(Slyzap.closestPlayer)
                                if quantity ~= nil and count > 0 then
                                    ...
                                    TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(Slyzap.closestPlayer), 'item_standard', ESX.PlayerData.inventory[i].name, quantity)
            ...
            elseif btn.name == "Haut" then
                TriggerEvent('Sly:VetHaut')
            elseif btn.name == "Bas" then
                TriggerEvent('Sly:VetBas')
            elseif btn.name == "Chaussure" then
                TriggerEvent('Sly:VetChaussure')
            ...
            if btn.slidename == "Donner" and btn.name == "Liquide :  ~g~" .. ESX.Math.GroupDigits(ESX.PlayerData.money).."$" then       
                    ...
                    if quantity ~= nil then
                        ...
                        if foundPlayers == true then
                            ...
                            if not IsPedSittingInAnyVehicle(closestPed) then
                                if post == true then
                                    if item == walletMoney then
                                        TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(Slyzap.closestPlayer), 'item_money', 'money', quantity)
                                        TaskPlayAnim(PlayerPedId(), "mp_common", "givetake2_a", 2.0, 2.0, 1000, 51, 0, false, false, false)
                                        OpenMenu("Portefeuille")
                                    end
                                else
            ...
            if btn.slidename == "Jeter" and btn.name == "Liquide :  ~g~" .. ESX.Math.GroupDigits(ESX.PlayerData.money).."$" then 
                local quantity = KeyboardInput("Montant", "Montant", "", 15)
                if quantity ~= nil then
                    local post = true
                    quantity = tonumber(quantity)
            ...
            if btn.slidename == "Donner" and btn.name == "Argent sale : ~r~" .. ESX.Math.GroupDigits(ESX.PlayerData.accounts[2].money).."$" then
                    local quantity = KeyboardInput("Montant", 'Montant', "", 15)
                if quantity ~= nil then
                    local post = true
                    quantity = tonumber(quantity)
                        ...
                        if not IsPedSittingInAnyVehicle(closestPed) then
                            if post == true then               
                                if item == walletdirtyMoney then
                                    TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(Slyzap.closestPlayer), 'item_account', 'black_money', quantity)
            ...
            if btn.slidename == "Jeter" and btn.name == "Argent sale : ~r~" .. ESX.Math.GroupDigits(ESX.PlayerData.accounts[2].money).."$" then
                local quantity = KeyboardInput("Montant", 'Montant', "", 15)
                    if quantity ~= nil then
                        local post = true
                        quantity = tonumber(quantity)
            ...
            if btn.name == "Gestion d'entreprise" and ESX.PlayerData.job.grade_name == "boss" then
                ...
                table.insert(menuf5.Menu["Gestion d'entreprise"].b, { name = "Argent Société : ~g~$" ..ESX.Math.GroupDigits(money) , ask = "", askX = true}) end, ESX.PlayerData.job.name)
            ...
            if btn.name == "Recruter" then 
                if ESX.PlayerData.job.grade_name == 'boss'  then
                    Slyzap.closestPlayer, Slyzap.closestDistance = ESX.Game.GetClosestPlayer()
                    if Slyzap.closestPlayer == -1 or Slyzap.closestDistance > 3.0 then
                        ESX.ShowNotification('Aucun joueur à ~b~proximité')
                    else
                        TriggerServerEvent('Sly:RecruterF5', GetPlayerServerId(Slyzap.closestPlayer), ESX.PlayerData.job.name, 0)
                    end
                else
            ...
            elseif btn.name == "Promouvoir" then
                if ESX.PlayerData.job.grade_name == 'boss' then
                    ...
                    if Slyzap.closestPlayer == -1 or Slyzap.closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('Sly:PromotionF5', GetPlayerServerId(Slyzap.closestPlayer))
                    end
                else
                    ESX.ShowNotification('Vous n\'avez pas les ~r~droits~w~')
                end
            elseif btn.name == "Virer" then 
                if ESX.PlayerData.job.grade_name == 'boss' then
                    ...
                    if Slyzap.closestPlayer == -1 or Slyzap.closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('Sly:VirerF5', GetPlayerServerId(Slyzap.closestPlayer))
                    end
                else
                    ESX.ShowNotification('Vous n\'avez pas les ~r~droits~w~')
                end
            elseif btn.name == "Destituer" then 
                if ESX.PlayerData.job.grade_name == 'boss' then
                    ...
                    if Slyzap.closestPlayer == -1 or Slyzap.closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('Sly:RetrograderF5', GetPlayerServerId(Slyzap.closestPlayer))
                    end
                else
                    ESX.ShowNotification('Vous n\'avez pas les ~r~droits~w~')
                end
            ...
            if btn.name == "Gestion gang" and ESX.PlayerData.job2.grade_name == "boss" then
                ...
                ESX.TriggerServerCallback('esx_society:getSocietyMoney', function(money)
                table.insert(menuf5.Menu["Gestion gang"].b, { name = "Argent Société : ~g~$" ..ESX.Math.GroupDigits(money) , ask = "", askX = true}) end, ESX.PlayerData.job2.name)
            ...
            if btn.name == "~s~Recruter" then 
                if ESX.PlayerData.job2.grade_name == 'boss'  then
                    ...
                    if Slyzap.closestPlayer == -1 or Slyzap.closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('Sly:MenuGangRecruterF5', GetPlayerServerId(Slyzap.closestPlayer), ESX.PlayerData.job2.name, 0)
                    end
                else
                    ESX.ShowNotification('Vous n\'avez pas les ~r~droits~w~')
                end
            elseif btn.name == "~s~Promouvoir" then
                if ESX.PlayerData.job2.grade_name == 'boss' then
                    ...
                    if Slyzap.closestPlayer == -1 or Slyzap.closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('Sly:MenuGangPromotionF5', GetPlayerServerId(Slyzap.closestPlayer))
                    end
                else
                    ESX.ShowNotification('Vous n\'avez pas les ~r~droits~w~')
                end
            elseif btn.name == "~s~Virer" then 
                if ESX.PlayerData.job2.grade_name == 'boss' then
                    ...
                    if Slyzap.closestPlayer == -1 or Slyzap.closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('Sly:MenuGangVirerF5', GetPlayerServerId(Slyzap.closestPlayer))
                    end
                else
                    ESX.ShowNotification('Vous n\'avez pas les ~r~droits~w~')
                end
            elseif btn.name == "~s~Destituer" then 
                if ESX.PlayerData.job2.grade_name == 'boss' then
                    ...
                    if Slyzap.closestPlayer == -1 or Slyzap.closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('Sly:MenuGangRetrograderF5', GetPlayerServerId(Slyzap.closestPlayer))
                    end
                else
                    ESX.ShowNotification('Vous n\'avez pas les ~r~droits~w~')
                end
            ...
            for i=1, #WeaponData, 1 do
                ...
                if btn.slidename == "Donner" and btn.name == WeaponData[i].label.."~b~ x"..currentAmmo then
					...
					if foundPlayers == true then
						local closestPed = GetPlayerPed(Slyzap.closestPlayer)
						if not IsPedSittingInAnyVehicle(closestPed) then
							TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(Slyzap.closestPlayer), 'item_weapon', WeaponData[i].name, currentAmmo)
							CloseMenu()
						else
            ...
            ESX.TriggerServerCallback(('Sly:getUsergroup'), function(group) 
            ...
            elseif btn.name == "Give ~g~cash" then
                ...
                TriggerServerEvent("Sly:AdminGiveMoneyMenuF", tik)
            ...
            if btn.name == "Véhicule invincible" and btn.checkbox == true then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, true)
                SetEntityInvincible(slyal, true)
            ...
            if btn.name == "Réparé" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, false)
                SetVehicleFixed(slyal)
                SetVehicleDirtLevel(slyal, 0.0)
            elseif btn.name == "Noir" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, lastVehicle)
                SetVehicleColours(slyal, 0, 0)
            elseif btn.name == "Blanc" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, lastVehicle)
                SetVehicleColours(slyal, 111, 111)
            elseif btn.name == "Gris" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, lastVehicle)
                SetVehicleColours(slyal, 13, 13)            
            elseif btn.name == "Bleu" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, lastVehicle)
                SetVehicleColours(slyal, 64, 64)
            elseif btn.name == "Rouge" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, lastVehicle)
                SetVehicleColours(slyal, 29, 29)
            elseif btn.name == "Vert" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, lastVehicle)
                SetVehicleColours(slyal, 92, 92)
            elseif btn.name == "Jaune" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, lastVehicle)
                SetVehicleColours(slyal, 89, 89)
            elseif btn.name == "Orange" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, lastVehicle)
                SetVehicleColours(slyal, 38, 38)
            elseif btn.name == "Rose" then
                local ped = PlayerPedId()
                local slyal = GetVehiclePedIsIn(ped, lastVehicle)
                SetVehicleColours(slyal, 135, 135)
            end
            
            ESX.TriggerServerCallback("Sly:AdminvehiculeMenuF", function(adminveh) 
                ...
                for i=1, #adminveh, 1 do 
                    if btn.name == adminveh[i].name then
                        ...
                        local je = adminveh[i].name
                        local pe = adminveh[i].label
                        local te = GetHashKey(pe)
                        RequestModel(te)
                        while not HasModelLoaded(te) do Citizen.Wait(0) end
                        local slyzapesti = CreateVehicle(te, pos, h, true, false)
                        TaskWarpPedIntoVehicle(PlayerPedId(), slyzapesti, -1)
                        SetVehRadioStation(slyzapesti, 'OFF')
                        return
                    end
                end
            ...
            for i=1, #listepistolet, 1 do
                if btn.name == listepistolet[i].name then
                    ...
                    TriggerServerEvent("Sly:AmmuAchatPistolet",label)
            ...
            for i=1, #listemitraillette, 1 do
                if btn.name == listemitraillette[i].name then
                    ...
                    TriggerServerEvent("Sly:AmmuAchatMitraillette",label)
            ...
            for i=1, #listepompe, 1 do
                if btn.name == listepompe[i].name then
                    ...
                    TriggerServerEvent("Sly:AmmuAchatPompe",label)
            ...
            for i=1, #listeassault, 1 do
                if btn.name == listeassault[i].name then
                    ...
                    TriggerServerEvent("Sly:AmmuAchatAssault",label)
            ...
            for i=1, #listefusilmitrailleur, 1 do
                if btn.name == listefusilmitrailleur[i].name then
                    ...
                    TriggerServerEvent("Sly:AmmuAchatMitrailleur",label)
            ...
            for i=1, #listesniper, 1 do
                if btn.name == listesniper[i].name then
                    ...
                    TriggerServerEvent("Sly:AmmuAchatSniper",label)
            ...
            for i=1, #listelanceur, 1 do
                if btn.name == listelanceur[i].name then
                    ...
                    TriggerServerEvent("Sly:AmmuAchatLanceur",label)
                end
            end
            ...
            for i=1, #listegrenade, 1 do
                if btn.name == listegrenade[i].name then
                    ...
                    TriggerServerEvent("Sly:AmmuAchatGrenade",label)
                end
            end
            ...
            for i=1, #listearmeblanche, 1 do
                if btn.name == listearmeblanche[i].name then
                    ...
                    TriggerServerEvent("Sly:AmmuAchatArmeBlanche",label)
                end
            end
            ...
            ESX.TriggerServerCallback("Sly:facture", function(bills) 
...
RegisterNetEvent('Sly:VetHaut')
AddEventHandler('Sly:VetHaut', function()
...
RegisterNetEvent('Sly:VetBas')
AddEventHandler('Sly:VetBas', function()
    ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skina)
        TriggerEvent('skinchanger:getSkin', function(skinb)
...
RegisterNetEvent('Sly:VetChaussure')
AddEventHandler('Sly:VetChaussure', function()
    ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skina)
        TriggerEvent('skinchanger:getSkin', function(skinb)
...
RegisterNetEvent('Sly:VetSac')
AddEventHandler('Sly:VetSac', function()
    ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skina)
        TriggerEvent('skinchanger:getSkin', function(skinb)
            local lib, anim = 'clothingtie', 'try_tie_neutral_a'
            ESX.Streaming.RequestAnimDict(lib, function()
...
RegisterCommand('Sly:OpenMenu', function()
    CreateMenu(menuf5)
end, false)
RegisterKeyMapping('Sly:OpenMenu', 'Menu Radial', 'keyboard', 'F5')
